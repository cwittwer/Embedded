...
static void _MAIN_THREAD_Tasks(void);
...
void SYS_Tasks ( void )
{
    ...
    /* Create OS Thread for MAIN_THREAD Tasks. */
    xTaskCreate((TaskFunction_t) _MAIN_THREAD_Tasks,
                "MAIN_THREAD Tasks",
                1024, NULL, 1, NULL);
...
/*******************************************************************************
  Function:
    void _MAIN_THREAD_Tasks ( void )

  Summary:
    Maintains state machine of MAIN_THREAD.
*/
